...
*/
    ...
    window.plugin.selectedportalcounts.getPortals = function (){
        ...
        var self = window.plugin.selectedportalcounts;
        ...
        $.each(window.portals, function(i, portal) {
            ...
            // just count portals within layers
            if (!countbool) return true;
            switch (team){
                case 1 :
                    self.resP++;
        ...
        if(window.useAndroidPanes()) {
            ...
            dialog({
                ...
                title: 'Selected Portal counts: ' + title,
                width: 'auto'
            });
        }
    }

    window.plugin.selectedportalcounts.makeBar = function(portals, text, color, shift) {
        var self = window.plugin.selectedportalcounts;
    ...
    window.plugin.selectedportalcounts.makePie = function(startAngle, endAngle, color) {
    ...
    window.plugin.selectedportalcounts.makeRing = function(startAngle, endAngle, color) {
        var self = window.plugin.selectedportalcounts;
        var large_arc = (endAngle - startAngle) > 0.5 ? 1 : 0;
    ...
    window.plugin.selectedportalcounts.format = function(str) {
        var re = /%s/;
    ...
    window.plugin.selectedportalcounts.onPaneChanged = function(pane) {
    ...
    var setup =  function() {
        ...
        if(window.useAndroidPanes()) {
            ...
            $('#toolbox').append(' <a onclick="window.plugin.selectedportalcounts.getPortals()" title="Display a summary of portals within drawn polygons">Selected Portal counts</a>');
        }
